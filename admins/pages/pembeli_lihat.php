...
<tr>
 ...
 <td width="100" align="center" valign="middle" bgcolor="#00FFFF">Nama Customer</td>
...
?>
 <tr>
  ...
  <td p align="left" bgcolor="#FFFFFF"><?php echo $data['nama'];?></td>
  <td p align="left" bgcolor="#FFFFFF"><?php echo $data['alamat'];?></td>
  <td p align="left" bgcolor="#FFFFFF"><?php echo $data['notelp'];?></td>
  <td p align="center" bgcolor="#FFFFFF">
	<a href="index.php?page=pembeli_edit&id=<?php echo$data['id'];?>">Edit</a>
	<a href="index.php?page=pembeli_hapus&id=<?php echo$data['id'];?>"onclick="return confirm('Yakin Mau Dihapus?');">HAPUS</a>
	<a href="index.php?page=pembeli_print&id=<?php echo$data['id'];?>">Print</a>
	</td>
</tr>
...
<div class="card-body">
<button onclick="location.href='index.php?page=pembeli_tambah'"type="button"class="btn btn-primary">Tambah</button>

...
include 'koneksi.php';
$id			=$_GET['id'];
$kucing	= mysqli_query($koneksi, "select * from tbl_tujuan where id='$id'");
$row		= mysqli_fetch_array($kucing);
?>
<hr><center>
<h2>EDIT DATA TUJUAN</h2></center>
<hr>
<form method="post" action="pages/tujuan_update.php">
...
<table>
	...
	<a href="index.php?page=tujuan">Kembali</a></td>
	</tr>
</table>
</form>